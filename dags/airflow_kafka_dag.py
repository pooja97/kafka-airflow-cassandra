...
from scripts.create_kafka_topic import kafka_create_topic_main
...
from scripts.check_mongodb_data import check_mongodb_main 

start_date = datetime(2024, 1, 10, 15, 42)
...
with DAG(dag_id = 'airflow_kafka_cassandra_mongodb', default_args=default_args, schedule_interval='@daily', catchup=False) as dag:
